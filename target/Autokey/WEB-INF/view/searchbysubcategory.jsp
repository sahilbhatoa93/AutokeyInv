...
<form  action="subCategorySearchResultTable" modelAttribute="Item">
<br><br><br><br><br><br><br><br>
  
 <div class="form-group" align="center">

  <label for="subCategoryName">Select Category and Sub Category</label>
  <br>
...
<br><br>			<select id="subCategoryName" name="subCategoryName" >
