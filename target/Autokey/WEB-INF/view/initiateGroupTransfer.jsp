...
<form  action="groupTransferRequest" modelAttribute="Transferdataect">
 ...
 <tr>
  ...
  <tr>
   ...
   <tr>
    ...
    <tr>
    <td>SKU</td>
    <td><input type="text"  class="ui-autocomplete-input" name="sku" value="${transferdataect.sku}" id="SKU" oninput="fillLocationFieldsFromSKU()"></td>		
  ...
  <tr>
    ...
    <td><input type="text" name="transferAmount" id="transferAmount" required="required" ></td>		
     <td><input type="button" name="printLabelButton" class="btn btn-default" value="Print Label" onclick="callPrint()"></td>		
  </tr>
   <tr>
   	 <td></td>
    <td><input type="submit" name="submitButton" class="btn btn-default" value="Review Transfer List"></td>
    	 <td><input type="submit" name="submitButton" class="btn btn-default" value="Add More Items"></td>
  </tr>
